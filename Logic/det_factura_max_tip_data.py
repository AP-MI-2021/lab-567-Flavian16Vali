from Domain.factura import get_tipul, get_str, get_nr_ap, get_id, get_data
...
def get_text_tip_factura(factura):
    return f'Avand id-ul: {get_id(factura)}, avand numarul apartamentului: {get_nr_ap(factura)}, cu valoarea de: {get_suma(factura)}, primita la data de {get_data(factura)}.'
